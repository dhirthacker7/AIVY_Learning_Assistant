...
with Diagram("End-to-End Research Tool Architecture", show=False, filename="research_tool_architecture", direction="LR", graph_attr={"ranksep": "1.5", "nodesep": "1.0"}):
    ...
    with Cluster("Airflow Pipeline - Data Acquisition and Preprocessing"):
        ...
        snowflake2 = Custom("Snowflake Database \n (python links)", "/Users/nishitamatlani/Documents/final_project/diagram/images/snowflake.png")  # Snowflake for storing user information
        ...
        pinecone = Custom("Pinecone Vector Database", "/Users/nishitamatlani/Documents/final_project/diagram/images/pinecone1.png") 

        # Data flow through the new pipeline
        airflow1 >> snowflake2 >> selenium  >> pinecone
        snowflake4 = Custom("Snowflake Database \n metadata for the extracted data", "/Users/nishitamatlani/Documents/final_project/diagram/images/snowflake.png")  # Snowflake for storing user information

        selenium >> snowflake4

        # New data acquisition pipeline
        airflow2 = Airflow("Airflow Scheduler")  # Orchestrates the pipeline
        gfg = Custom("Webpage for link extraction \n (based on keyword)", "/Users/nishitamatlani/Documents/final_project/diagram/images/gfg.png")  # Web scraping with Selenium
        python2 = Custom("Python link generator \n (based on keyword)", "/Users/nishitamatlani/Documents/final_project/diagram/images/python.png")  # Web scraping with Selenium
    ...
    with Cluster("Multi-Agent System - Research Agents"):
        ...
        research_agent = Custom("Reseach Agent", "/Users/nishitamatlani/Documents/final_project/diagram/images/arxiv.png")
    ...
    with Cluster("User Interaction Interface - Frontend"):
        ...
        streamlit = Custom("Streamlit User Interface", "/Users/nishitamatlani/Documents/final_project/diagram/images/streamlit.png")  # User interacts with the system via Copilot UI
